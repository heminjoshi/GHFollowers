...
class GFAlertVC: UIViewController {
    ...
    func configureMessageLabel(){
        ...
        NSLayoutConstraint.activate([
            ...
            messageLabel.leadingAnchor.constraint(equalToSystemSpacingAfter: containerView.leadingAnchor, multiplier: padding),
            messageLabel.trailingAnchor.constraint(equalToSystemSpacingAfter: containerView.trailingAnchor, multiplier: -padding),
